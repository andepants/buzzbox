...
final class MessageEntity {
    ...
    /// Indicates if message was auto-generated by AI (FAQ response)
    var isAIGenerated: Bool = false

    /// Indicates if message is an FAQ auto-response (subset of isAIGenerated)
    var isFAQResponse: Bool = false

    /// Timestamp when AI processing completed
    var aiProcessedAt: Date?

    /// Indicates if AI processing failed
    var aiProcessingFailed: Bool = false
